    ...
    <div class="interviews-grid">
        <%
            ...
            try {
                ...
                URL url = new URL("http://localhost:8080/api/v1/students/interviews");
        ...
        %>
        <div class="card">
            <h4>Event ID: <%= interview.getString("eid") %></h4>
            <p><strong>Interviewer:</strong> <%= interview.getString("interviewer") %></p>
            <p><strong>Location:</strong> <%= interview.getString("location") %></p>
            <p><strong>Date:</strong> <%= interview.getString("date") %></p>
            <a href="./sendfeedback.jsp?eid=<%= interview.getString("eid") %>" class="btn">Send Feedback</a>
        </div>
        <%
                    }
                } catch (Exception e) {
