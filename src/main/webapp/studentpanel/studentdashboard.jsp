...
<%
    ...
    String role = "Student"; // Placeholder for role, replace with actual session role if available
    try {
        ...
        if (responseCode == 200) {
            ...
            // role = jsonObject.optString("role", "Student");
        } else {
...
<div class="landing">
    <div>
        <h1>Welcome, <%= role %>!</h1>
        <p>Your gateway to learning and exploration.</p>
    </div>
</div>
